...
emerge xorg-server mesa x11-libs/cairo libev pixman xterm twm xf86-video-virtualbox libdrm libXdamage libXxf86vm xinit qtgui ffmpeg vlc recode libaacplus poppler app-crypt/gnupg
